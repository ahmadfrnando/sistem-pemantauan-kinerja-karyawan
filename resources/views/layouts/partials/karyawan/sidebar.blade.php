<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('karyawan.riwayat-tugas.*') ? 'active bg-gradient-dark text-white' : '' }} text-dark" href="{{ route('karyawan.riwayat-tugas.index') }}">
                    <i class="material-symbols-rounded opacity-5">history</i>
                    <span class="nav-link-text ms-1">Riwayat Tugas</span>
                </a>
            </li>
        </ul>
    </div>
