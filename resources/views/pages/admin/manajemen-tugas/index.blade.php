            ...
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                    <div class="d-flex justify-content-between align-items-center px-3">
                        <h6 class="text-white text-capitalize ps-3">Data Master Tugas</h6>
                        <a href="{{ route('admin.manajemen-tugas.create') }}" class="btn btn-primary">Tambah Tugas</a>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table data-table">
                        <thead class="text-sm">
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary font-weight-bolder opacity-7">Karyawan</th>
...
<script type="text/javascript">
    $(function() {
        var route = 'admin.manajemen-tugas.index';
        ...
        $(document).on('click', '#delete', function() {
            var id = $(this).data('id');
            var route = "{{ route('admin.manajemen-tugas.destroy', ':id') }}";
